...
for ind in range(len(dirlist)):
    ...
    mask = loadSegArraywithID(path,'mask')
    img = loadImgArraywithID(path,'mask')
    params = '../Feature Extraction/Paramsescc.yaml'
...
dataframe.to_csv('../Expected results/Features_Radiomics.csv')