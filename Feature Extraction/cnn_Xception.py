...
model = Xception(weights=r'..\example\models\xception_weights_tf_dim_ordering_tf_kernels_notop.h5', include_top=False)
...
dataframe.to_csv('../Expected results/Features_Xception.csv')