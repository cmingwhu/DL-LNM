...
model = ResNet50(weights=r'..\example\models\resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5', include_top=False)
# Load batch file
...
dataframe.to_csv('../Expected results/Features_Resnet.csv')