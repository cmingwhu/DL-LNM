...
model = InceptionResNetV2(weights=r'..\example\models\inception_resnet_v2_weights_tf_dim_ordering_tf_kernels_notop.h5', include_top=False)
...
dataframe.to_csv('../Expected results/Features_InceptionResNetV2.csv')