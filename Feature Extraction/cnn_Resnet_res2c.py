...
base_model = ResNet50(weights=r'..\example\models\resnet50_weights_tf_dim_ordering_tf_kernels.h5', include_top=True)
...
dataframe.to_csv('../Expected results/Features_Resnet_res2c.csv')
